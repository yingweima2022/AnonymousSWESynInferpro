...
def validate(
    ...
    tests_passed, msg, pass2pass = execution.run_test_suite_for_correctness(
        repo_name,
        output_dir,
        project_path,
        test_cmd,
    ...
    log_and_print(logger, f"[Validation] Finishing. Result is {tests_passed}. Pass2Pass is {pass2pass} Message: {msg}.")
    return tests_passed, msg, pass2pass
